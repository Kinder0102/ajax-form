import { STRING_NON_BLANK, FUNCTION, HTML_SELECT, HTML_CHECKBOX, HTML_RADIO } from 'js-common/js-constant'
import { assert, isFunction, isNotBlank } from 'js-common/js-utils'
import { querySelector, triggerEvent } from 'js-common/js-dom-utils'

let HANDLERS_BEFORE = { clear }
let HANDLERS_AFTER = { submit }

export default class AjaxFormResetHandler {
